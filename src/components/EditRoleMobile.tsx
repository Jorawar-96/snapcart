    ...
    <div className='flex flex-col items-center min-h-screen p-6 w-full'>
      <motion.h1 
        ...
        >
            ...
            type="tel" 
            id='mobile' 
            className='w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 foucs:outline-none text-gray-800' 
        ...
        className={`inline-flex items-center gap-2 font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-5 w-[190px] ${
