...
function Welcome({nextStep}:propType) {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white'>
      ...
      className='mt-4 text-gray-700 text-lg md:text-xl max-w-lg'>You one-stop destination for fresh groceries, organic produce, and daily essentials delivered rights to your doorstep.</motion.p>
      ...
      >
        ...
        <Bike className='w-25 h-24 md:w-32 md:h-32 text-orange-500 drop-shadow-md'/>
      </motion.div>
